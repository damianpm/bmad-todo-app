# Product Requirement Document (PRD) — Todo App (Source Input)

> Verbatim copy of the user-supplied PRD. This file is the canonical input for the BMAD analyst, PM, architect, and SM agents downstream. Do not edit — refinements live in `PRD.md`.
